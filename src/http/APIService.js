...
export class APIService {
  ...
  // ==================== Users ====================
  getProfile() {
    return this.apiClient.get("/api/profile/", this.getAuthHeader());
  }
  ...
  editProfile(profileData) {
    ...
    return this.apiClient.put("/api/profile/update/", profileData, config);
  }
  // ==================== Expenses ====================
  ...
  // ==================== Helper Methods ====================
  sendEmail(emailData) {
    const csrfToken = getCookie("csrftoken"); // Get CSRF cookie
    return this.apiClient.post(
      `/contact/`,
      emailData,
      {
        headers: {
          ...
          ...this.getAuthHeader().headers, // Include authentication headers
        },
      }
    );
  }
