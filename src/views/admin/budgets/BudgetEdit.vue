  ...
  <div class="page-container">
    <form @submit.prevent="submitForm" class="form-card">
      <div class="form-header">
        <h2 class="form-title">Edit Budget</h2>
        <p class="form-description">
          Modify the budget details below. All fields marked with an asterisk (<span class="required-star">*</span>) are required.
        </p>
      </div>
      <div class="form-grid">
...
<style scoped>
/* Reset to use the styles from BudgetCreate.vue */
.page-container {
  padding: 25px;
